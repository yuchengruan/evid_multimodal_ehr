...
# REPLACE THE HYPERPARAMETERS BELOW
hparams_dict = {
# Common arguments
"seed": 10,
"logger": False,
...
"dataset":  "mortality",
"n_class": 2,
"data_path": "./data/datasets/mimic_v2",
"structured_d_in_ls": [22, 19],
"class_weight": [0.567, 4.254],
...
def train(hparams: Any, logger: Any) -> None:
    ...
    # REPLACE THIS WITH ANY MODELS UNDER models/ DIRECTORY
